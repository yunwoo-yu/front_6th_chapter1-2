    ...
    return (
      <div className="text-center py-12">
        <div className="text-red-500 mb-4">
          <img src="/error-large-icon.svg" alt="오류" className="mx-auto h-12 w-12" />
        </div>
    ...
    return (
      <div className="text-center py-12">
        <div className="text-gray-400 mb-4">
          <img src="/search-large-icon.svg" alt="검색" className="mx-auto h-12 w-12" />
        </div>
      ...
      {loading && products.length > 0 && (
        <div className="text-center py-4">
          <div className="inline-flex items-center">
            <img src="/loading-icon.svg" alt="로딩" className="animate-spin h-5 w-5 text-blue-600 mr-2" />
